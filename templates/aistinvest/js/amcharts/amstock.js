(function() {
    ...
    e.AmStockChart = e.Class({
        ...
        parseStockData: function(a, b, c, d, k) {
            ...
            }, g.processTimeout) : g.parseEvents(a, g.panels, g.stockEventsSettings, g.firstDayOfWeek,
        ...
        parseEvents: function(a, b, c, d, k, g) {
            ...
            for (p = 0; p < h; p++) {
                ...
                r = t.graphs;
                l = r.length;
                for (f = 0; f < l; f++) n = r[f], n.customBulletField = "amCustomBullet" + n.id + "_" + t.id, n.bulletConfigField = "amCustomBulletConfig" + n.id + "_" + t.id, n.chart = t;
                for (f = 0; f < d.length; f++) l = d[f], n = l.graph, e.isString(n) && (n = e.getObjById(r, n)) && (l.graph = n), n && (l.panel = n.chart)
            }
            for (var y in m)
            ...
            if (a) {
                ...
                if (b) {
                    ...
                    if (0 < a.dataProvider.length) {
                        ...
                        b.dataProvider = g ? a.agregatedDataProviders[g] : a.agregatedDataProviders[d]
                    } else b.dataProvider = [];
                    g = b.categoryAxis;
                    g.minPeriod = d;
        ...
        zoomChart: function(a, b) {
            ...
            if (k && g) {
                ...
                c.animationPlayed = !0;
                f = e.newDate(b);
                t && c.updateScrollbar && (t.zoomToDates(a, f), c.skipScrollbarEvent = !0, setTimeout(function() {
                    c.resetSkip.call(c)
                }, 100));
                c.updateScrollbar = !0;
                c.startDate = a;
                c.endDate = b;
                l && l.zoom(a, b);
                c.skipEvents || a.getTime() == c.previousStartDate.getTime() && b.getTime() == c.previousEndDate.getTime() || (l = {
                    type: "zoomed"
                }, l.startDate = a, l.endDate = b, l.chart = c, l.period = m, c.fire(l), c.previousStartDate = e.newDate(a), c.previousEndDate = e.newDate(b))
            }
    ...
    e.DataSetSelector = e.Class({
        ...
        write: function(a) {
            ...
            if (1 < b.countDataSets("showInSelect")) {
                ...
                a.appendChild(l);
                e.isNN && l.addEventListener("change", function(a) {
                    b.handleDataSetChange.call(b, a)
                }, !0);
                e.isIE && l.attachEvent("onchange", function(a) {
                    b.handleDataSetChange.call(b, a)
                });
...
//                    }
//                    for (c = 0; c < g.length; c++)
//                        if (p = g[c], !0 === p.showInCompare && p != b.chart.mainDataSet) {
//                            f = document.createElement("option");
//                            f.text = p.title;
//                            f.value = c;
